...
Ext.example = function() {
	...
	function createBox(t, s) {
		return ['<div align=left><div class="msg" style="width:180px;">',
			'<div class="x-box-tl"><div class="x-box-tr"><div class="x-box-tc"></div></div></div>',
			'<div class="x-box-ml"><div class="x-box-mr"><div class="x-box-mc" style="font-size=12px;"><h3>', t,
			'</h3>', s, '</div></div></div>',
			'<div class="x-box-bl"><div class="x-box-br"><div class="x-box-bc"></div></div></div>', '</div></div>'].join('');
	}
	return {
		msg : function(title, message, autoHide, pauseTime) {
			...
			//给消息框右下角增加一个关闭按钮
			message += '<br><span style="text-align:right;font-size:12px; width:100%;"></span>'
