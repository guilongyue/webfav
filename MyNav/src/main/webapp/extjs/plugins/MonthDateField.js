...
Ext.ux.MonthDateField = Ext.extend(Ext.form.TriggerField,  {
    format : "m/d/Y",
    ...
    initComponent : function(){
        Ext.ux.MonthDateField.superclass.initComponent.call(this);
    ...
    validateValue : function(value){
        ...
        if(!Ext.ux.MonthDateField.superclass.validateValue.call(this, value)){
            return false;
        }
     ...
     */
    getValue : function(){
        return this.parseDate(Ext.ux.MonthDateField.superclass.getValue.call(this)) || "";
    },

    setValue : function(date){
        Ext.ux.MonthDateField.superclass.setValue.call(this, this.formatDate(this.parseDate(date)));
    },
    ...
    onDestroy : function(){
        ...
        Ext.ux.MonthDateField.superclass.onDestroy.call(this);
    },
    ...
    onTriggerClick : function(){
        ...
        if(this.menu == null){
            this.menu = new Ext.ux.MonthDateMenu();//改动的地方
        }
...
Ext.reg('monthdatefield', Ext.ux.MonthDateField);
Ext.ux.MonthDatePicker = Ext.extend(Ext.Component, {
    /**
    ...
    // private
    initComponent : function(){
        Ext.ux.MonthDatePicker.superclass.initComponent.call(this);
...
Ext.reg('monthdatepicker', Ext.ux.MonthDatePicker);
Ext.ux.MonthDateItem = function(config) {
	Ext.ux.MonthDateItem.superclass.constructor.call(this, new Ext.ux.MonthDatePicker(config), config);
...
Ext.extend(Ext.ux.MonthDateItem, Ext.menu.Adapter, {
	onSelect : function(picker, date) {
		this.fireEvent("select", this, date, picker);
		Ext.ux.MonthDateItem.superclass.handleClick.call(this);
	}
});
Ext.ux.MonthDateMenu = function(config) {
	Ext.ux.MonthDateMenu.superclass.constructor.call(this, config);
	this.plain = true;
	var di = new Ext.ux.MonthDateItem(config);
	this.add(di);
...
Ext.extend(Ext.ux.MonthDateMenu, Ext.menu.Menu, {
	cls : 'x-date-menu',
	beforeDestroy : function() {
		this.picker.destroy();
	}
